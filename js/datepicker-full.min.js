!function() {
      ...
      performBeforeHook(e, t, s)
      {
          ...
          if (n) {
              ...
              n.content && function(e, t) {
                  A(e),
                  t instanceof DocumentFragment ? e.appendChild(t) : "string" == typeof t ? e.appendChild(F(t)) : "function" == typeof t.forEach && t.forEach((t => {
                      e.appendChild(t)
                  }))
              }(e, n.content)
          }
  ...
  class ie extends te {
      ...
      setOptions(t)
      {
          ...
          i && Array.from(this.dow.children).forEach(((e, t) => {
  ...
  class ae extends te {
      ...
      {
          var i;
          t && (this.navStep = 10 * this.step, this.beforeShowOption = `beforeShow${i = this.cellClass, [...i].reduce(((e, t, i) => e + (i ? t : t.toUpperCase())), "")}`, this.grid = this.element, this.element.classList.add(this.name, "datepicker-grid"), this.grid.appendChild(F(r("span", 12)))),
          super.init(e)
      }
      setOptions(t)
      {
  ...
  class Se {
      constructor(e)
      {
          ...
          ve(this, t),
          this.viewDate = be(e),
          j(e, [[s, "mousedown", we], [a, "click", me.bind(null, e)], [f.viewSwitch, "click", fe.bind(null, e)], [f.prevBtn, "click", pe.bind(null, e)], [f.nextBtn, "click", ge.bind(null, e)], [f.todayBtn, "click", he.bind(null, e)], [f.clearBtn, "click", ue.bind(null, e)]]),
  ...
  function Ee(e, t) {
      ...
      if (s.active) {
          if (e.editMode)
              return void ("Enter" === i ? e.exitEditMode({
                  update: !0,
          ...
          if ("ArrowLeft" === i)
              ...
              if ("Enter" !== i)
                  return void ("Escape" === i ? s.hide() : "Backspace" !== i && "Delete" !== i && (1 !== i.length || t.ctrlKey || t.metaKey) || e.enterEditMode());
              if (a)
                  return void e.setDate(s.viewDate);
  ...
  class je {
      constructor(e, t={}, i)
      {
          ...
          a ? (d = s(e.dataset.date, n.dateDelimiter), delete e.dataset.date) : d = s(r.value, n.dateDelimiter),
          this.dates = [];
          const o = Ye(this, d);
  ...
  function Ke(e, t) {
      ...
      const s = e.datepickers,
          ...
          d = s[a].dates[0],
          o = s[r].dates[0];
      void 0 !== d && void 0 !== o ? 0 === a && d > o ? (s[0].setDate(o, n), s[1].setDate(d, n)) : 1 === a && d < o && (s[0].setDate(d, n), s[1].setDate(o, n)) : e.allowOneSidedRange || void 0 === d && void 0 === o || (n.clear = !0, s[r].setDate(s[a].dates, n)),
